...
class TestTemporalProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.reference_time = datetime(2025, 7, 10, 14, 30, 0, tzinfo=pytz.timezone("America/Los_Angeles"))
    
    def test_simple_tomorrow(self):
        """Test parsing 'tomorrow' expressions."""
        result = self.processor.preprocess("Remind Joel tomorrow at 3pm to check batteries", self.reference_time)
    ...
    def test_explicit_timezone(self):
        ...
        result = self.processor.preprocess("Tell Bryan at 2PM CST tomorrow to restart servers", self.reference_time)
    ...
    def test_city_timezone(self):
        ...
        result = self.processor.preprocess("at 2pm Houston time, remind Joel to check the generators", self.reference_time)
    ...
    def test_end_of_hour(self):
        ...
        result = self.processor.preprocess("Check telemetry at end of the hour", self.reference_time)
        
        self.assertGreaterEqual(result['confidence'], 0.9)
        self.assertEqual(result['temporal_data']['due_time'], '14:59')  # Next hour minus 1 minute
    
    def test_top_of_hour(self):
        """Test 'top of the hour' expression."""
        result = self.processor.preprocess("Meeting at top of the hour", self.reference_time)
    ...
    def test_end_of_day(self):
        ...
        result = self.processor.preprocess("Submit report by end of day", self.reference_time)
    ...
    def test_weekend(self):
        ...
        result = self.processor.preprocess("Do maintenance this weekend", self.reference_time)
    ...
    def test_reminder_before(self):
        ...
        result = self.processor.preprocess("Remind Joel 30 minutes before the 4pm meeting", self.reference_time)
    ...
    def test_no_temporal_expression(self):
        ...
        result = self.processor.preprocess("Check the generator oil levels", self.reference_time)
    ...
    def test_today_expression(self):
        ...
        result = self.processor.preprocess("Finish the task today at 5pm", self.reference_time)
...
class TestPerformance(unittest.TestCase):
    ...
    def test_preprocessing_speed(self):
        ...
        for text in test_cases:
            ...
            self.assertLess(elapsed, 0.05, f"Preprocessing '{text}' took {elapsed:.3f}s")
